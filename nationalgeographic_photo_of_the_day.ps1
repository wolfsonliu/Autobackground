...
$webresult = (curl "https://www.nationalgeographic.com/photography/photo-of-the-day/")

$imgurl =  (($webresult | select-string "yourshot")[0].ToString().Split('"') | select-string "yourshot").ToString()
$imgpath = $savelocation + (date -I"date") + ".jpg"
# Download figure
